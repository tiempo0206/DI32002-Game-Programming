...
| --- | --- | --- | --- | --- | --- | --- |
| Hangar Building Modular | 3D environment asset package | Official Unity Asset Store URL: `https://assetstore.unity.com/packages/3d/environments/industrial/hangar-building-modular-142104` | 3dfactorio | Standard Unity Asset Store EULA; Asset Store package ID `142104` | `Assets/Hangar Building Modular/Materials`, `Assets/Hangar Building Modular/Meshes`, `Assets/Hangar Building Modular/Prefabs`, `Assets/Hangar Building Modular/Textures` | Visible hangar arena dressing, floor, walls, crates, scaffolds, pallets, lamps, and industrial props in `MVP_ShootingTest.unity` |
...
- Official Unity Asset Store page: `https://assetstore.unity.com/packages/3d/environments/industrial/hangar-building-modular-142104`
- Publisher: 3dfactorio
- Asset Store package ID: `142104`
...
- The package was imported into the project from the `.unitypackage` supplied by the project owner.
...
- [x] Record the official Unity Asset Store page, publisher, package ID, and license for `Hangar Building Modular`.
